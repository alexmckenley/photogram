...
namespace CameraControl
{
    public partial class MainWindow : Form, IObserver
    {
        ...
        private string captureDirectoryPath = Environment.GetFolderPath(Environment.SpecialFolder.MyPictures) + @"\photogram";
        ...
        private void remoteCaptureButton_Click(object sender, EventArgs e)
        {
        ...
        private void _cameraSettings_Click(object sender, EventArgs e)
        {
        ...
        private void changeDirectory_Click(object sender, EventArgs e)
        {
            ...
            {
                captureDirectoryPath = folderBrowserDialog1.SelectedPath;
                selectedDirLabel.Text = captureDirectoryPath;
            }
        }
    }
